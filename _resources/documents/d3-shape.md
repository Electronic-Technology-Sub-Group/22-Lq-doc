...
[![PieChart|295](ext[d3-shape]pie.png)](https://observablehq.com/@d3/pie-chart)[![Donut Chart|295](ext[d3-shape]donut.png)](https://observablehq.com/@d3/donut-chart)
...
[![Circular Sector Centroids|250](ext[d3-shape]centroid-circular-sector.png)](https://observablehq.com/@d3/pie-settings)[![Annular Sector Centroids|250](ext[d3-shape]centroid-annular-sector.png)](https://observablehq.com/@d3/pie-settings)
...
[![Rounded Circular Sectors|250](ext[d3-shape]rounded-annular-sector.png)](https://observablehq.com/@d3/pie-settings)[![Rounded Annular Sectors|250](ext[d3-shape]rounded-annular-sector.png)](https://observablehq.com/@d3/pie-settings)
...
[![Padded Circular Sectors|250](ext[d3-shape]padded-circular-sector.png)](https://observablehq.com/@d3/pie-settings)[![Padded Annular Sectors|250](ext[d3-shape]padded-annular-sector.png)](https://observablehq.com/@d3/pie-settings)
...
[![Line Chart|295](ext[d3-shape]line.png)](https://observablehq.com/@d3/line-chart)
...
[![Line with Missing Data|480](ext[d3-shape]line-defined.png)](https://observablehq.com/@d3/line-with-missing-data)
...
![Radial Line|250](ext[d3-shape]line-radial.png)
...
[![Area Chart|295](ext[d3-shape]area.png)](https://observablehq.com/@d3/area-chart)[![Stacked Area Chart|295](ext[d3-shape]area-stacked.png)](https://observablehq.com/@d3/stacked-area-chart)[![Difference Chart|295](ext[d3-shape]area-difference.png)](https://observablehq.com/@d3/difference-chart)
...
[![Area with Missing Data|480](ext[d3-shape]area-defined.png)](https://observablehq.com/@d3/area-with-missing-data)
...
![Radial Area|250](ext[d3-shape]area-radial.png)
...
![basis|888](ext[d3-shape]basis.png)
...
![basisClosed|888](ext[d3-shape]basisClosed.png)
...
![basisOpen|888](ext[d3-shape]basisOpen.png)
...
![bumpX|888](ext[d3-shape]bumpX.png)
...
![bumpY|888](ext[d3-shape]bumpY.png)
...
![bundle|888](ext[d3-shape]bundle.png)
...
![cardinal|888](ext[d3-shape]cardinal.png)
...
![cardinalClosed|888](ext[d3-shape]cardinalClosed.png)
...
![cardinalOpen|888](ext[d3-shape]cardinalOpen.png)
...
![catmullRom|888](ext[d3-shape]catmullRom.png)
...
![catmullRomClosed|888](ext[d3-shape]catmullRomClosed.png)
...
![catmullRomOpen|888](ext[d3-shape]catmullRomOpen.png)
...
![linear|888](ext[d3-shape]linear.png)
...
![linearClosed|888](ext[d3-shape]linearClosed.png)
...
![monotoneX|888](ext[d3-shape]monotoneX.png)
...
![monotoneY|888](ext[d3-shape]monotoneY.png)
...
![natural|888](ext[d3-shape]natural.png)
...
![step|888](ext[d3-shape]step.png)
...
![stepAfter|888](ext[d3-shape]stepAfter.png)
...
![stepBefore|888](ext[d3-shape]stepBefore.png)
...
[![Tidy Tree](ext[d3-shape]tree.png)](https://observablehq.com/@d3/tidy-tree)
...
[![#symbolCircle|100](ext[d3-shape]circle.png)](#symbolCircle)[![#symbolCross|100](ext[d3-shape]cross.png)](#symbolCross)[![#symbolDiamond|100](ext[d3-shape]diamond.png)](#symbolDiamond)[![#symbolSquare|100](ext[d3-shape]square.png)](#symbolSquare)[![#symbolStar|100](ext[d3-shape]star.png)](#symbolStar)[![#symbolTriangle|100](ext[d3-shape]triangle.png)](#symbolTriangle)[![#symbolWye|100](ext[d3-shape]wye.png)](#symbolWye)
...
[![Stacked Bar Chart|295](ext[d3-shape]stacked-bar.png)](https://observablehq.com/@d3/stacked-bar-chart)[![Streamgraph|295](ext[d3-shape]stacked-stream.png)](https://observablehq.com/@mbostock/streamgraph-transitions)
...
title: "GitHub - d3/d3-shape: Graphical primitives for visualization, such as lines and areas."
description: "Graphical primitives for visualization, such as lines and areas. - d3/d3-shape"
host: github.com
favicon: https://github.githubassets.com/favicons/favicon.svg
image: https://opengraph.githubassets.com/394170b9fc6c4e5e308eb8a99917e80db6b5c07e5cef0fb941b2df0e8e3083a7/d3/d3-shape
```
